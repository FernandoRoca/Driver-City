 ...
 //constructor
	...
	function Eliminar_Logo_Negocio($id_negocio=0){
		...
		if($this->con->conectar()==true){
			...
			return mysql_query("update negocio id_principal=".$id_principal.",nombre='".$nombre."',direccion='".$direccion."',descripcion='".$descripcion."',web='".$web."',logo='".$logo."',posicion_x=".$x.",posicion_y=".$y.",fecha_inicio='".$fecha_inicio."',fecha_final='".$fecha_final."' where id_negocio = ".$id_negocio);
		}
	}
