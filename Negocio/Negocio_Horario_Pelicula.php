...
var $objD_Gestionar_Horario_Pelicula;
           ...
           if($horario == "") {
                ...
                if($fecha_inicio == "") {
                    ...
                    if($fecha_fin == "") {
                        ...
                        if($this->objD_Gestionar_Horario_Pelicula->Insertar_Horario_Pelicula($id_pelicula,$horario,$fecha_inicio,$fecha_fin)){
                            echo"<script>
        ...
        if($consulta) {
          while($Tabla_Horario_Pelicula = mysql_fetch_array($consulta)) {
              echo' <tr>
                  ...
                  <td align="middle">
                      <span class="dele">
                          <a href="Horario_Pelicula.php?id_horario_pelicula=';
                              echo base64_encode($Tabla_Horario_Pelicula['id_horario_pelicula']);
                              echo'&nombre=">
    ...
    function Eliminar_Horario_Pelicula($id_horario_pelicula=0){
        if($this->objD_Gestionar_Horario_Pelicula->Eliminar_Horario_Pelicula($id_horario_pelicula) == true){
            echo "<script>
