...
function Mostrar_Imagenes_Principal($latitud=0,$longitud=0){
  ...
  echo '  <table border="0" cellspacing="5" cellpadding="5">
            ...
            <tbody>
                ...
                $consulta=$this->objD_Gestionar_Principal->Mostrar_Imagen_Principal(4);
                                 ...
                                 echo " <td ><a rel=\"external\" href=\"Clasificacion.php?id_principal=". base64_encode(4)."&tipo=".base64_encode("Bares")."&latitud=".$latitud."&longitud=".$longitud."\"><img  width=\"100%\" height=\"100%\" src=\"../../img/Imagen_Principal/".$Combo_Principal['imagen']."\"/></a></td>";
              ...
              echo'   </tr>
               ...
               $consulta=$this->objD_Gestionar_Principal->Mostrar_Imagen_Principal(5);
                    ...
                    echo " <td  ><a rel=\"external\" href=\"Listado_Negocios.php?id_principal=".  base64_encode(5)."&tipo=".base64_encode("Karaokes")."&latitud=".$latitud."&longitud=".$longitud."\"><img  width=\"100%\" height=\"100%\" src=\"../../img/Imagen_Principal/".$Combo_Principal['imagen']."\"/></a></td>";
                    ...
                    echo "<td><a rel=\"external\" href=\"Listado_Negocios.php?id_principal=".  base64_encode(1)."&tipo=".base64_encode("Boliches")."&latitud=".$latitud."&longitud=".$longitud."\"><img width=\"100%\" height=\"100%\" src=\"../../img/Imagen_Principal/".$Combo_Principal['imagen']."\" class=\"img-rounded\"\></a></td>";
               ...
               echo' </tr>
                ...
                <tr>';
                    ...
                    echo " <td ><a rel=\"external\" href=\"Listado_Negocios.php?id_principal=".  base64_encode(3)."&tipo=".base64_encode("Bares")."&latitud=".$latitud."&longitud=".$longitud."\"><img  width=\"100%\" height=\"100%\" src=\"../../img/Imagen_Principal/".$Combo_Principal['imagen']."\"/></a></td>";
