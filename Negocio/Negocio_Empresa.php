...
var $objD_Gestionar_Empresa;
    ...
    function Modificar_Empresa_sin_Logo($id_empresa=0,$nombre="",$descripcion="") {
        if($id_empresa == 0) {
                echo"<script>
            ...
            echo "<meta http-equiv = refresh content = 1; URL = Empresa.php>";
                ...
                if($descripcion == "") {
                    ...
                    if($this->objD_Gestionar_Empresa->Modificar_sin_Logo_Empresa($id_empresa, $nombre, $descripcion)) {
                                    echo"<script>
     ...
     function Modificar_Empresa_Logo($id_empresa=0,$nombre="",$logo="",$descripcion="") {
        if($id_empresa == 0) {
                echo"<script>
                    alert('Seleccione una Empresa para su modificacion!!');
                </script>";
            ...
            echo "<meta http-equiv = refresh content = 1; URL = Empresa.php>";
                ...
                if($descripcion == "") {
                    ...
                    $consulta=$this->objD_Gestionar_Empresa->Obtener_Logo_Empresa($id_empresa);
                                if($consulta) {
                                while( $Logo_Empresa = mysql_fetch_array($consulta) ){
                                            if($Logo_Empresa['logo']!="")
                                            unlink("../../img/Logo_Empresa/".$Logo_Empresa['logo'] );
                                          }
                                          }
                    if($this->objD_Gestionar_Empresa->Modificar_Logo_Empresa($id_empresa, $nombre,$logo, $descripcion)) {
                                    echo"<script>
                                        alert('Modificacíon Realizada con Exito!!');
                                    </script>";
                                    echo "<meta http-equiv = refresh content = 1; URL = Empresa.php>";
