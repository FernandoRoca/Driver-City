...
var $objD_Gestionar_Clasificacion;
    ...
    function Menu_Clasificacion($id_principal=0){
        ...
        while( $Clasificacion = mysql_fetch_array($consulta) ){
            if($cont==0){
             echo '  <tr><td>
                <a href="javascript:obtener_localizacion(';echo ($id_principal); echo');"> 
                <div style="height: 100%; position: relative; text-align: midle; width: 100%;" >
