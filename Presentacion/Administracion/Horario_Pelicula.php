...
<body>    
    ...
    <div class="container">
        ...
        <div class="content_adm" align="center">
            ...
            <?php
                ...
                $id_horario_pelicula    = base64_decode(@$_GET['id_horario_pelicula']);
            ...
            <select id="Negocio" name="Negocio" onchange="location.href=this.value">
            	<?php
                    ...
                    $objN_Pelicula->Combo_Negocio_HorarioCine($id_negocio);
	...
	<?php
            ...
            if($id_horario_pelicula>0){
                $objN_Horario_Pelicula->Eliminar_Horario_Pelicula($id_horario_pelicula);
                echo "<script> location.href='Horario_Pelicula.php';</script>";
            }
            
            if (@$_REQUEST['Enviar'] == "Asignar Horario"){

                $objN_Horario_Pelicula->Insertar_Horario_Pelicula(
                                            $_POST["Pelicula"],
                                            $_POST["Horario"],
                                            $_POST["FechaInicio"],
                                            $_POST["FechaFin"]);
