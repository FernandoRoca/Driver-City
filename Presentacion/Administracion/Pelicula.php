    ...
    <div class="container">
        ...
        <div class="content_adm" align="center">
           ...
           <p> Nombre </p>
            ...
            <p>Imagen</p>
            <input name="Imagen" type="file" class="casilla" id="archivo" style="color: #ffffff;" size="35" value="<?php echo $imagen ?>"/>
        ...
        if (@$_REQUEST['Modificar'] == "Modificar"){
            if((isset($_POST["Mantener_Imagen"]))) {
                $objN_Pelicula->Modificar_sin_Logo_Pelicula( $id_pelicula,
                ...
                $objN_Pelicula->Modificar_Logo_Pelicula( $id_pelicula,
                                                    $_POST["Nombre"],
                                                    $_POST["Director"],
                                                    $_POST["Genero"],
                                                    $direccion_img,
